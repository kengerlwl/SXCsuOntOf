...
public class SendMailUtil {
    ...
    //发件人邮箱
    private static String myEmailAccount = "SXBlog_holiday@163.com";

    //发件人邮箱密码（授权码）
    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String myEmailPassword = "AJFYYATCBRUUUZIJ";
    ...
    public static void sendEmail(String toEmailAddress, String emailTitle, String emailContent) throws Exception{
        ...
        // 设置邮件服务器主机名
        props.setProperty("smtp.163.com", myEmailSMTPHost);
...
//        builder.append("\n官网：" + "https://www.hbuecx.club");
        ...
        msg.setFrom(new InternetAddress(myEmailAccount,"SXBlog", "UTF-8"));
        ...
        toAddr[0] = new InternetAddress(myEmailAccount);//自己的邮箱 抄送防止554
        toAddr[1] = new InternetAddress(toEmailAddress);//对方的邮箱
