<template>
  <div id="home">
    <div id="first-part">
      ...
      <b-container class="carousel-content">
        <!-- Content here -->
        <b-carousel
          id="carousel-1"
          v-model="slide"
    ...
    <div id="second-part">
      <div class="descript">
        <p class="des-title">優雅的寫作方式</p>
        <p class="des-content">使用 Markdown 作為編寫語言，寫起來輕鬆方便。</p>
        <vue-typer
          :text="typerContent"
          :repeat="Infinity"
          :shuffle="false"
    ...
    <div id="third-part">
      <div class="des-image">
        <img src="../../assets/api.png" width="400" height="400" alt="api" />
      </div>
      <div class="descript">
        <p class="des-title">多種 API 服務選擇</p>
        <p class="des-content">提供方便的 API 給使用者選擇。</p>
      </div>
    </div>
    <div id="end-part">
      <b-container>
